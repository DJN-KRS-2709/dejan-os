...
People who are different from me. Different thinking, different beliefs, different ways of approaching the work. That mix is how I get out of my own box and find solutions I would have missed.

Bring a point of view. Bring a hypothesis. Bring data when you have it. Do not bring theater.

## The best way you can check in on me is …

Slack. I only use email to accept invites.

## You’ll convince me to get on board by …

Being honest, and substantiating what you believe with a well-founded hypothesis or with data. I will not get on board because the deck is polished. I will get on board when the bet is clear.

## What motivates me to come into work each day is …

I thrive in uncertainty. I like finding the problem, making the process more honest, shaping strategy, and helping people become more capable than they were yesterday. Passion is not a side effect. It is how I work.

## When I'm dealing with stress, I …

Feel disorganized. I cannot give enough time to the few things that actually matter. That can make me feel unproductive, and my mood drops. If you see that, say so. Directly. I would rather hear it than guess.
...
I need a way to track impact. If we cannot see whether the work changed anything, we are decorating.

## My best working patterns look like …

I am an early bird. Mornings are for deep-focus work. Protect that if you can.

I prefer async. Write it. I will read it. Meetings are for the things writing cannot hold: feedback, conflict, strategy, the conversation where we actually need to see each other.
...
If you need a rubber stamp, I am the wrong person. If you need someone to help make the mess legible, I am the right one.
...
Machine-readable copy: [`dejan.json`](./dejan.json)

Short context file: [`llms.txt`](./llms.txt)

Agent instructions: [`AGENTS.md`](./AGENTS.md)

This is a living document. If something here is wrong, tell me on Slack.
